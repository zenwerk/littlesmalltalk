...
object *primitive(primnumber, numargs, args) int primnumber, numargs;
object **args;
{
  object *resultobj;
  ...
  switch (primnumber)
  {
    ...
    case 6: /* built in object type testing */
      ...
      if (is_bltin(args[0]) == is_bltin(args[1]))
        if (is_bltin(args[0]))
          ...
          leftint = (args[0]->class == args[1]->class);
      goto return_boolean;
    ...
    case 30: /* doPrimitive:withArguments: */
      if (numargs != 2)
        goto argcerror;
      resultobj = primitive(leftint, args[1]->size, &args[1]->inst_var[0]);
      goto return_obj;
    ...
    case 51:
      if (isupper(leftint))
        leftint += 'a' - 'A';
      leftint = (leftint == 'a') || (leftint == 'e') || (leftint == 'i') ||
                (leftint == 'o') || (leftint == 'u');
      goto return_boolean;
...
#define TWOPI (double)6.2831853072
    ...
    case 97: /* make a new class (generated by parser)*/
      ...
      if (!is_symbol(args[2]))
        goto argterror;
      if (!is_integer(args[6]))
        goto argterror;
      if (!is_integer(args[7]))
        goto argterror;
    ...
    case 99: /* find a class in class dictionary */
      ...
      {
        sprintf(strbuffer, "cannot find class %s", leftp);
    ...
    case 113: /*  object grow */
      ...
      if (is_bltin(leftarg))
        goto argterror;
      resultobj = new_obj(leftarg->class, leftarg->size + 1, 0);
      if (leftarg->super_obj)
        sassign(resultobj->super_obj, leftarg->super_obj);
    ...
    case 122: /* format for error printing */
      ...
      sprintf(strbuffer, "%s: %s", symbol_value(aClass->class_name), leftp);
      leftp = strbuffer;
    ...
    case 126: /* printAt: */
      ...
      if (numargs != 3)
        goto argcerror;
      if ((!is_string(args[0])) || (!is_integer(args[1])) ||
          (!is_integer(args[2])))
        goto argterror;
    ...
    case 128: /* reference count error */
      if (numargs != 1)
        goto argcerror;
      sprintf(strbuffer, "object %p reference count %d", args[0],
              args[0]->ref_count);
      errp = strbuffer;
      goto return_error;
    ...
    case 129: /* does not respond error */
      ...
      sprintf(strbuffer, "%s: does not respond to %s",
              symbol_value(aClass->class_name), symbol_value(args[1]));
      errp = strbuffer;
      goto return_error;
    ...
    case 130: /* file open */
      ...
      if (!is_string(args[2]))
        goto argterror;
      file_open(phil, string_value(args[1]), string_value(args[2]));
      goto return_nil;
    ...
    case 141: /* newProcess (withArguments:) */
      ...
      if (numargs == 1)
        resultobj =
          (object *)block_execute((interpreter *)0, (block *)args[0], 0, args);
      else if (numargs == 2)
        resultobj =
          (object *)block_execute((interpreter *)0, (block *)args[0],
                                  args[1]->size, &(args[1]->inst_var[0]));
      else
        goto argcerror;
      if (((object *)0) == resultobj)
        goto return_nil;
    ...
    case 145: /* set the state of a process */
      ...
      switch (leftint)
      {
        ...
        case 3:
          ...
          break;
        default:
          errp = "invalid state for process";
          goto return_error;
      }
    ...
    case 174: /* circle(x, y, r) */
      ...
      for (i = 0; i < 3; i++)
        if (!is_integer(args[i]))
          goto argterror;
      circle(int_value(args[0]), int_value(args[1]), int_value(args[2]));
      goto return_nil;
    ...
    case 175: /* arg(x, y, x0, y0, x1, y1) */
      ...
      for (i = 0; i < 6; i++)
        if (!is_integer(args[i]))
          goto argterror;
      arc(int_value(args[0]), int_value(args[1]), int_value(args[2]),
          int_value(args[3]), int_value(args[4]), int_value(args[5]));
      goto return_nil;
    ...
    default:
      fprintf(stderr, "Primitive number %d not implemented\n", primnumber);
      goto return_nil;
  }
...
argterror:
  sprintf(strbuffer, "argument type not correct for primitive %d", primnumber);
  errp = strbuffer;
  goto return_error;
...
int fprnt_radix(f, n, buffer) double f;
int n;
char buffer[];
{
  int sign, exp, i, j;
...
int generality(aNumber) object *aNumber;
{
  int i;

  if (is_integer(aNumber))
    i = 1;
  else if (is_float(aNumber))
    i = 2;
  else
    i = 3;
  return (i);
...
cant_happen(n) int n;
{
  ...
  {
    case 1:
      s = "out of memory allocation space";
      break;
    case 2:
      s = "array size less than zero";
      break;
    case 3:
      s = "block return from call should not occur";
      break;
    case 4:
      s = "attempt to make instance of non class";
      break;
    case 5:
      s = "case error in new integer or string";
      break;
    case 6:
      s = "decrement on unknown built in object";
      break;
    case 7:
      s = "cannot find class Object";
      break;
    case 8:
      s = "primitive free of object of wrong type";
      break;
    case 9:
      s = "internal interpreter error";
      break;
    case 11:
      s = "block execute on non-block";
      break;
    case 12:
      s = "out of symbol space";
      break;
    case 14:
      s = "out of standard bytecode space";
      break;
    case 15:
      s = "system deadlocked - all processes blocked";
      break;
    case 16:
      s = "attempt to free symbol";
      break;
    case 17:
      s = "invalid process state passed to set_state";
      break;
    case 18:
      s = "internal buffer overflow";
      break;
    case 20:
      s = "can't open prelude file";
      break;
    case 22:
      s = "system file open error";
      break;
    case 23:
      s = "fastsave error";
      break;
    default:
      s = "unknown, but impossible nonetheless, condition";
      break;
  }
#endif
