...
noreturn nameTableInsert(dict, hash, key, value) object dict, key, value;
int hash;
{
...
object hashEachElement(dict, hash, fun) object dict;
register int hash;
int (*fun)();
{
...
object nameTableLookup(dict, str) object dict;
char *str;
{
  charBuffer = str;
...
char *unStrs[] = {"isNil", "notNil",    "value", "new",         "class",
