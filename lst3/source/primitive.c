...
object firstarg, secondarg;
{
  ...
  switch (number)
  {
    ...
    case 7: /* symbol set */
      nameTableInsert(symbols, strHash(charPtr(firstarg)), firstarg, secondarg);
      break;
...
static object intBinary(number, firstarg, secondarg) register int firstarg,
  secondarg;
int number;
{
  boolean binresult;
    ...
    switch (primitiveGroup)
    {
      ...
      case 5: /* integer unary operations */
        if (!isInteger(arguments[0]))
          ...
          returnedObject =
            intUnary(primitiveNumber - 50, intValue(arguments[0]));
        break;
      ...
      case 7: /* integer binary operations */
        if ((!isInteger(arguments[0])) || !isInteger(arguments[1]))
          ...
          returnedObject =
            intBinary(primitiveNumber - 60, intValue(arguments[0]),
      ...
      case 10: /* float unary */
        returnedObject =
          floatUnary(primitiveNumber - 100, floatValue(arguments[0]));
        break;

      case 11: /* float binary */
        returnedObject =
          floatBinary(primitiveNumber - 110, floatValue(arguments[0]),
