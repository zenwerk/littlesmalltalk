...
#define IUPMASK_UINT "/d+"
  ...
  int iupmaskMatSet(Ihandle *h, char *mask, int autofill, int casei, int lin,
                    int col);
  int iupmaskMatSetInt(Ihandle *h, int autofill, int min, int max, int lin,
                       int col);
  int iupmaskMatSetFloat(Ihandle *h, int autofill, float min, float max,
                         int lin, int col);
