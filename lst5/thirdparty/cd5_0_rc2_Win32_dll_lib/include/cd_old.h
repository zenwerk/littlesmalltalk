...
extern "C"
{
  ...
  int cdPlay(cdContext* context, int xmin, int xmax, int ymin, int ymax,
             void* data);

  /* coordinate transformation */
  void cdGetCanvasSize(int* width, int* height, double* width_mm,
                       double* height_mm);
  ...
  void cdTextBox(int x, int y, const char* s, int* xmin, int* xmax, int* ymin,
                 int* ymax);
  ...
  void cdPutImageRectRGB(int iw, int ih, const unsigned char* r,
                         const unsigned char* g, const unsigned char* b, int x,
                         int y, int w, int h, int xmin, int xmax, int ymin,
                         int ymax);
  void cdPutImageRectRGBA(int iw, int ih, const unsigned char* r,
                          const unsigned char* g, const unsigned char* b,
                          const unsigned char* a, int x, int y, int w, int h,
                          int xmin, int xmax, int ymin, int ymax);
  void cdPutImageRectMap(int iw, int ih, const unsigned char* index,
                         const long* colors, int x, int y, int w, int h,
                         int xmin, int xmax, int ymin, int ymax);

/* defined for backward compatibility */
#define cdPutImageRGB(iw, ih, r, g, b, x, y, w, h) \
  cdPutImageRectRGB((iw), (ih), (r), (g), (b), (x), (y), (w), (h), 0, 0, 0, 0)
#define cdPutImageRGBA(iw, ih, r, g, b, a, x, y, w, h)                         \
  cdPutImageRectRGBA((iw), (ih), (r), (g), (b), (a), (x), (y), (w), (h), 0, 0, \
                     0, 0)
#define cdPutImageMap(iw, ih, index, colors, x, y, w, h)                     \
  cdPutImageRectMap((iw), (ih), (index), (colors), (x), (y), (w), (h), 0, 0, \
                    0, 0)
#define cdPutImage(image, x, y) cdPutImageRect((image), (x), (y), 0, 0, 0, 0)
  ...
  void cdPutImageRect(cdImage* image, int x, int y, int xmin, int xmax,
                      int ymin, int ymax);
