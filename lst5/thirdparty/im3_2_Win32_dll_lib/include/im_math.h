...
inline T imZeroOrderDecimation(int width, int height, T *map, float xl,
                               float yl, float box_width, float box_height,
                               TU Dummy)
{
  int x0, x1, y0, y1;
  (void)Dummy;
 ...
 * \ingroup math */
template <class T, class TU>
inline T imBilinearDecimation(int width, int height, T *map, float xl, float yl,
                              float box_width, float box_height, TU Dummy)
{
  int x0, x1, y0, y1;
  (void)Dummy;
 ...
 * \ingroup math */
template <class T>
inline T imZeroOrderInterpolation(int width, int height, T *map, float xl,
                                  float yl)
{
  int x0 = (int)(xl - 0.5f);
  int y0 = (int)(yl - 0.5f);
 ...
 * \ingroup math */
template <class T>
inline T imBilinearInterpolation(int width, int height, T *map, float xl,
                                 float yl)
{
  int x0 = (int)(xl - 0.5f);
  int y0 = (int)(yl - 0.5f);
  ...
  return (T)((fhh - flh - fhl + fll) * u * t + (fhl - fll) * t +
             (flh - fll) * u + fll);
}
 ...
 * \ingroup math */
template <class T, class TU>
inline T imBicubicInterpolation(int width, int height, T *map, float xl,
                                float yl, TU Dummy)
{
  (void)Dummy;
