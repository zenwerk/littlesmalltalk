...
struct object *nilObject, *trueObject, *falseObject, *globalValues,
  *SmallIntClass, *ArrayClass, *BlockClass, *IntegerClass;
...
int symbolBareCmp(unsigned char *left, int leftsize, unsigned char *right,
                  int rightsize)
{
...
void bigBang(void)
{
  struct object *ObjectClass, *MetaObjectClass, *ClassClass, *NilClass,
    *TrueClass, *FalseClass, *StringClass, *TreeClass, *DictionaryClass,
    *OrderedArrayClass, *MetaClassClass, *ByteArrayClass;
